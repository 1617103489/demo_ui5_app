		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo_UI5_App",
									"targetURL": "#demoui5appdemoui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoui5appdemoui5app-display": {
								"semanticObject": "demoui5appdemoui5app",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoui5app.demoui5app",
									"url": sap.ui.require.toUrl("demoui5app/demoui5app")
								}
							}
						}
					}
